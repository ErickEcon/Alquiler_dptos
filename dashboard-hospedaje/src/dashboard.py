...
def _kpi_cards(m: MetricasNegocio) -> go.Figure:
    ...
    kpis = [
        ...
        ("🏆 Hab. más rentable",  m.habitacion_mas_rentable,            "Por ingresos"),
...
<head>
  ...
  <style>
    ...
    .grafica {{ background: white; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.08); margin-bottom: 24px; padding: 12px; }}
  </style>
</head>
<body>
